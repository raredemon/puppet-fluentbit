...
define fluentbit::input::tail (
  ...
  Stdlib::Absolutepath $configfile                          = "/etc/td-agent-bit/inputs/tail_${name}.conf",
  ...
  Optional[Enum['On', 'Off']] $skip_long_lines              = undef,
  ...
  Optional[Enum['On', 'Off']] $docker_mode                  = undef,
